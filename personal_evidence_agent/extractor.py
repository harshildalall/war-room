    ...
    msg = client.messages.create(
        ...
        messages=[{
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": "Transcribe ALL text from this medical document exactly as written. Include every word, date, diagnosis, medication, and clinical finding. Do not summarize."
                }
            ]
        }]
    )
